...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opciones) {
                case 1:
                    // Solicitar las notas del primer corte (tareas, quiz, parcial)
                    ...
                    // Solicitar las notas del segundo corte (tareas, quiz, parcial)
                    ...
                    // Solicitar las notas del tercer corte (tareas, quiz, parcial)
                    ...
                    // Calcular promedios de los tres cortes
                    ...
                    // Calcular la nota definitiva basada en los pesos
                    double notaDefinitiva = (promedioCorte1 * 0.35) + (promedioCorte2 * 0.35) + (promedioCorte3 * 0.30);

                    // Mostrar el resultado según la nota definitiva
